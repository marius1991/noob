...
/**
 * <p>Java-Klasse für commentOnLocationResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="commentOnLocationResponse">
 *   &lt;complexContent>
...
@XmlType(name = "commentOnLocationResponse", propOrder = {
    "_return"
})
public class CommentOnLocationResponse {
